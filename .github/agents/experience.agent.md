...
tools:
  [
    ...
    aws-mcp/aws___call_aws,
    aws-mcp/aws___get_regional_availability,
    aws-mcp/aws___list_regions,
    aws-mcp/aws___read_documentation,
    aws-mcp/aws___recommend,
    aws-mcp/aws___retrieve_agent_sop,
    aws-mcp/aws___search_documentation,
    aws-mcp/aws___suggest_aws_commands,
