            ...
            <CardBody>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="mb-6">
저는 협업과 소통을 핵심 가치로 삼는 소프트웨어 개발자입니다. 20살부터 다양한 조직과 팀에서 활동하며, 성향이나 배경이 다른 사람들과도 조율하고 함께 프로젝트를 완수해온 경험이 제 가장 큰 강점입니다. 어떤 팀이든, 어떤 스타일의 동료든 함께 목표를 향해 나아가는 힘은 결국 ‘잘 듣고, 정확히 말하며, 끝까지 책임지는 태도’라고 믿고 실천해왔습니다.
첫 직장에서는 백엔드 개발자로 입사해 데이터 마이닝과 API 서버 구축 업무를 맡았습니다. 기술적 기초와 함께 데이터 흐름과 시스템 설계를 실무 중심으로 익힐 수 있었고, 이후 프론트엔드로 전환하여 LG, SK 등 다양한 클라이언트와 협업 프로젝트를 선임 개발자로서 이끌며 UI/UX 구현과 팀 내 코드 품질 관리까지 폭넓은 책임을 수행했습니다.
오픈소스 분석에 관심이 많아 꾸준히 기술 스택을 확장하고 있으며, 특히 관측 가능성(Observability) 분야에서 OpenTelemetry를 활용한 모니터링 구성에 흥미를 갖고 실습과 적용을 이어가고 있습니다.
Airflow와 Argo Workflows를 이용한 배치 처리 자동화에도 익숙하며, 네트워크와 AI 관련 기술은 꾸준한 학습과 실험을 통해 실무 활용 가능성을 넓히고 있습니다.
인프라 측면에서도 Kubernetes 기반의 마이크로서비스 운영, 온프레미스 환경에서의 직접적인 시스템 구축, AWS와 GCP 같은 클라우드 환경에서의 배포까지 두루 경험했습니다. 개발자이자 운영자로서 서비스의 전 과정을 이해하고 대응할 수 있는 역량을 갖추고자 노력하고 있습니다.
기술은 빠르게 변하지만, 팀워크와 실행력은 꾸준함에서 나옵니다.
저는 기술적 깊이와 팀 내 협업력, 두 축을 함께 성장시키며 함께 일하기 좋은 개발자, 그리고 함께 성과를 내는 개발자가 되기 위해 오늘도 한 걸음씩 나아가고 있습니다.
                  </p>
