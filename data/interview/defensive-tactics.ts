...
export const defensiveTacticsQuestions: LocalizedInterviewQuestion[] = [
  ...
  // 공통 방어 전략
  {
    ...
    category2: "Gap Defense",
    question: {
      ko: "특정 기술 스택(예: Kafka Streams, Flink)에 대한 실무 경험이 부족한데, 어떻게 빠르게 따라잡을 수 있나요?",
    },
    answer: {
      ko:
  ...
  // 금융권 경험 부족
  {
    ...
    category2: "Gap Defense",
    question: {
      ko: "금융권에서 일해본 경험이 없는데, 전자금융감독규정 같은 규제를 이해하고 대응할 수 있나요?",
    },
    answer: {
      ko:
  ...
  // 일반적인 Gap 대응 프레임워크
  {
    ...
    category2: "Gap Defense",
    question: {
      ko: "JD에 명시된 [특정 기술/경험]이 부족한데, 이 포지션에 적합하다고 생각하시나요?",
    },
    answer: {
      ko:
  ...
  // ─── Wipro Cloud DevOps/SRE Engineer (Harman) JD 대응 질문 ───────────────
  {
    ...
    priority: "high",
    question: {
      ko: "JD에서 AWS 외에 Azure나 GCP 경험을 요구하는데, AWS 이외의 클라우드 경험이 있나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    priority: "high",
    question: {
      ko: "인프라 자동화 스크립트를 개발한 경험을 구체적으로 설명해주세요. 보안과 비용 최적화 자동화 경험이 있나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    priority: "high",
    question: {
      ko: "DataDog 사용 경험이 없는데, 모니터링 스택을 어떻게 운영했나요? Grafana/Prometheus로 DataDog을 대체할 수 있나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    priority: "high",
    question: {
      ko: "프로덕션 환경에서 발생한 가장 복잡한 장애를 어떻게 해결했나요? 근본 원인 분석 프로세스를 설명해주세요.",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    priority: "high",
    question: {
      ko: "Java/Spring 환경에서 프로덕션 장애를 해결한 경험을 설명해주세요. 특히 메모리 누수나 성능 이슈를 어떻게 진단했나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    priority: "high",
    question: {
      ko: "글로벌 팀에서 일한 경험이 있나요? 영어로 기술 커뮤니케이션을 어떻게 하나요?",
    },
    answer: {
      ko:
  ...
  // Linux OS & 네트워크 인프라
  {
    ...
    priority: "high",
    question: {
      ko: "Linux 운영체제와 네트워크 인프라에 대한 이해를 설명해주세요. 실무에서 Linux 트러블슈팅 경험이 있나요?",
    },
    answer: {
      ko:
  ...
  // Cloud-Native 사고방식
  {
    ...
    priority: "high",
    question: {
      ko: "Cloud-Native 사고방식이란 무엇이며, 실무에서 어떻게 적용했나요? Self-healing, 컨테이너화, 자동화 경험을 설명해주세요.",
    },
    answer: {
      ko:
  ...
  // EKS 기반 CI/CD (GitHub, Jenkins, ArgoCD)
  {
    ...
    priority: "high",
    question: {
      ko: "EKS 환경에서 CI/CD 파이프라인을 구축한 경험을 설명해주세요. GitHub, Jenkins, ArgoCD를 어떻게 조합했나요?",
    },
    answer: {
      ko:
  ...
  // Helm Chart 관리 경험
  {
    ...
    priority: "high",
    question: {
      ko: "Helm Chart를 활용한 Kubernetes 워크로드 관리 경험을 설명해주세요. Chart 설계와 배포 전략은 어떻게 했나요?",
    },
    answer: {
      ko:
  ...
  // ─── CloudFormation & DR 보완 ─────────────────────────────────────────────
  {
    ...
    priority: "high",
    question: {
      ko: "CloudFormation 경험이 있나요? Terraform과 어떻게 구분해서 사용했는지 설명해주세요.",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    priority: "high",
    question: {
      ko: "고가용성(HA)과 재해 복구(DR) 설계 경험을 설명해주세요. 실제 장애 상황에서 어떻게 대응했나요?",
    },
    answer: {
      ko:
