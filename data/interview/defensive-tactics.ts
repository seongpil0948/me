...
export const defensiveTacticsQuestions: InterviewQuestion[] = [
  ...
  // 공통 방어 전략
  {
    ...
    answer:
      ...
      "- 팀 내 지식 공유 (발표, 문서화)\n\n" +
      "**결론:**\n\n" +
      "특정 기술 경험이 부족한 것은 사실이지만, 제가 가진 **기반 지식, 학습 능력, 다른 전문성**이 팀 적응에 걸림돌이 되지 않을 것입니다. 오히려 Cloud, Monitoring, 특히 **OpenTelemetry와 Observability 분야**에서 팀 전체에 즉시 기여할 수 있는 강점이 있습니다. 제가 빠르게 학습하는 동안 다른 영역에서 팀을 도우며, [해당 기술]도 수개월 내 프로덕션 수준으로 다룰 수 있다고 자신합니다.",
  },
  ...
  // 대규모 환경 경험 부족
  {
    ...
    answer:
      ...
      "대규모 환경을 배우기 위한 준비:\n\n" +
      "**사전 학습 계획 (입사 전):**\n" +
      "- 토스 블로그 SLASH 발표 전체 학습\n" +
      "- Istio 대규모 운영 사례 연구 (Google, Airbnb)\n" +
      "- Kubernetes Scaling 전략 심화 학습\n" +
      "- 금융권 DevOps 규제 사전 조사\n\n" +
      "**입사 후 Ramp-Up:**\n" +
      "- **1개월**: 기존 시스템 아키텍처 완벽 이해\n" +
      "- **2-3개월**: 소규모 프로젝트로 기여 시작\n" +
      "- **6개월**: 대규모 프로젝트 독립 수행\n" +
      "- **1년**: 새로운 대규모 최적화 제안\n\n" +
      "**5. 즉시 기여 가능한 영역**\n\n" +
      "규모와 무관하게 즉시 기여:\n\n" +
      ...
      "- 배포 자동화 고도화\n\n" +
      "**결론:**\n\n" +
      "현재 규모는 작지만, **확장 가능한 아키텍처 설계 능력**과 **본질적 문제 해결 능력**은 검증되었습니다. 대규모 환경 경험은 제가 귀사에서 배우고 싶은 핵심 이유이며, 동시에 제 OpenTelemetry 전문성과 자동화 철학은 즉시 기여할 것입니다. 규모의 차이는 학습으로 극복 가능하지만, 제가 가진 DevOps 철학과 문제 해결 능력은 이미 증명되었습니다. 대규모 환경에서 더 큰 임팩트를 내고 싶어 지원했습니다.",
  },
  ...
  // 금융권 경험 부족
  {
    ...
    answer:
      ...
      "**6. 협업 의지**\n\n" +
      "토스 블로그에서 강조한 것처럼:\n" +
      '> "보안 엔지니어분들과 최대한 협업하면서 해결하고, 더 편리하고 안전하게 만들 방법이 없을지 치열하게 고민"\n\n' +
      "제가 추구하는 방향:\n" +
      "1. **경청**: 보안팀의 우려사항 적극 수용\n" +
      "2. **제안**: 규제 준수하면서도 생산성 유지하는 방법 제시\n" +
      "3. **자동화**: 사람의 실수를 줄이는 자동화 도구 개발\n" +
      "4. **교육**: 개발자들에게 규제의 중요성 공유\n\n" +
      "**결론:**\n\n" +
      "금융권 경험은 없지만, **규제 준수와 생산성 균형**이라는 본질적 과제는 이미 경험했습니다. 전자금융감독규정은 학습 가능하며, 제가 가진 자동화 철학과 보안 Observability 전문성은 오히려 금융권 DevOps에 더 큰 가치를 제공할 것입니다. 보안팀과 적극 협업하며 **'더 안전하고 더 편리한'** 방법을 찾는 것이 제 목표입니다. 금융 규제는 제약이 아니라 **DevOps 플랫폼을 더 견고하게 만드는 새로운 목표**라고 생각합니다.",
  },
