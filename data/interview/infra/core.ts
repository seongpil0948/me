...
export const infraCoreQuestions: LocalizedInterviewQuestion[] = [
  {
    ...
    answer: {
      ko:
        ...
        "둘째, RBAC과 NetworkPolicy로 멀티 테넌시를 구현하는 방법을 배웠습니다. 여러 조직과 서비스가 하나의 클러스터를 공유하는 환경에서는 네임스페이스 격리와 권한 관리가 필수인데, 이미 실무에서 경험해봤기 때문에 빠르게 적응할 수 있을 것 같아요.\n\n" +
  ...
  },
  {
    ...
    answer: {
      ko:
        ...
        "핵심 교훈은, 최신 기술이 항상 정답은 아니라는 거예요. EKS가 기술적으로 더 나아도, 팀 상황과 비즈니스 우선순위를 고려하면 ECS가 더 현명한 선택일 수 있죠. 새로운 환경에서도 현재 팀 성숙도와 운영 목표에 맞춰 단계적으로 EKS의 장점을 살리는 접근이 맞다고 생각합니다.",
      en: "A concise AWS answer covering real production context, key decision trade-offs, measurable outcomes, and takeaways.",
    },
  },
  {
