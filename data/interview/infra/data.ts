...
export const infraDataQuestions: LocalizedInterviewQuestion[] = [
  ...
  },
  {
    ...
    category1: "Infrastructure",
    category2: "Data Pipeline",
    question: { ko: "데이터 파이프라인 장애 복구를 어떻게 처리하나요?" },
    answer: {
      ko:
        "데이터 파이프라인 장애 복구에서 가장 중요한 것은 빠른 감지와 자동 복구입니다. AWS Step Functions, Athena, Glue, S3 기반 파이프라인에서 실제로 마주한 문제들과 해결 방법을 설명하겠습니다.\n\n" +
        "AWS SNS 기반 에러 알림 시스템을 구축했습니다. Step Functions의 각 State에서 실패가 발생하면 즉시 SNS Topic으로 알림을 보냈어요. Lambda에서 Athena 쿼리 실패, Glue Job 실패, S3 권한 오류 등을 감지하면 Slack으로 알림을 전송했습니다. 에러 메시지에는 실패한 Step, 에러 타입, 처리 중이던 데이터 경로, 재실행 가능 여부를 포함했죠. 이렇게 해서 장애 발생 후 5분 내 담당자가 인지할 수 있었어요.\n\n" +
  ...
  },
  {
    ...
    question: {
      ko: "파이프라인에서 데이터 품질 모니터링을 어떻게 구현하나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    answer: {
      ko:
        ...
        "첫 번째는 SLA 모니터링과 알림이었습니다. Airflow의 SLAs parameter를 각 DAG에 설정했어요. 예를 들어 매일 오전 9시까지 완료되어야 하는 리포트 DAG는 sla=timedelta(hours=12)로 설정했습니다. SLA Miss가 발생하면 자동으로 Slack 알림이 발송되었죠.\n\n" +
  ...
  },
  {
    ...
    question: {
      ko: "Airflow 분산 환경에서 OpenTelemetry 연동 시 발생한 'Failed to encode key file_path: Invalid type DagFileInfo' 에러를 어떻게 해결했나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "Airflow Worker의 Task 할당 지연 문제(8초)를 어떻게 해결했나요? Worker 증설과 동시성 튜닝 경험을 설명해주세요.",
    },
    answer: {
      ko:
