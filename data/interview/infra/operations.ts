 ...
 * ID: 32, 33, 36, 39, 63
 */
export const infraOperationsQuestions: LocalizedInterviewQuestion[] = [
  {
    id: 32,
    ...
    answer: {
      ...
      en: "A concise Redis answer covering real production context, key decision trade-offs, measurable outcomes, and takeaways.",
    },
  },
  {
    id: 13,
  ...
  },
  {
    ...
    answer: {
      ...
      en: "A concise Security answer covering real production context, key decision trade-offs, measurable outcomes, and takeaways.",
    },
  },
  {
    id: 39,
    ...
    question: {
      ko: "Describe your experience with disaster recovery planning.",
    },
    answer: {
      ko:
      ...
      en: "A concise Disaster Recovery answer covering real production context, key decision trade-offs, measurable outcomes, and takeaways.",
    },
  },
  {
    id: 76,
  ...
  },
  {
    ...
    question: {
      ko: "Nginx 대신 APISIX를 중앙 API 게이트웨이로 도입한 기술적 이유는 무엇인가요? Spring Cloud Eureka와 어떻게 연동했고, API 지연시간을 40% 감소시킨 구체적인 방법은?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    category2: "CI/CD",
    question: {
      ko: "Jenkins 기반 ECS 배포 파이프라인을 구축하셨는데, CloudFormation 대신 Jenkins를 선택한 이유가 무엇인가요?",
    },
    answer: {
      ko:
