...
export const infraObservabilityQuestions: LocalizedInterviewQuestion[] = [
  ...
  },
  {
    ...
    category2: "Monitoring",
    question: {
      ko: "마이크로서비스 환경에서의 모니터링 전략은 어떻게 접근하나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: { ko: "분산 트레이싱 구현에서 어떤 어려움을 겪었나요?" },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: { ko: "효과적인 알림 전략을 어떻게 구현하나요?" },
    answer: {
      ko:
  ...
  },
  {
    ...
    category1: "Infrastructure",
    category2: "Time-Series Database",
    question: { ko: "시계열 데이터 보존 및 스토리지를 어떻게 최적화하나요?" },
    answer: {
      ko:
  ...
  },
  {
    ...
    category1: "Infrastructure",
    category2: "Observability",
    question: { ko: "SRE 실천 방법에 대해 어떻게 접근하나요?" },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "OpenTelemetry Collector의 Pipeline 구조를 설명하고, 프로젝트에서 어떻게 구성했나요? 12개 프로덕션 서버에 어떤 배포 방식을 사용했고, 3TB 분산 추적 데이터를 어떻게 효율적으로 관리하나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "Synthetic Monitoring과 Self-Healing 시스템을 어떻게 구현했나요? 특히 자체 설치형 환경에서 Managed APM 유료 기능 없이 컨테이너와 HTTP 엔드포인트 가용성을 어떻게 모니터링하고 자동 복구했나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "OpenTelemetry Collector의 고가용성(HA)을 AWS 환경에서 어떻게 구현했나요? ADOT + NLB + ECS 아키텍처를 선택한 이유와 구체적인 구성을 설명해주세요.",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "OnPremise 환경에서 APISIX Gateway를 활용한 OTEL Collector 고가용성 아키텍처를 어떻게 설계했나요? Health Check, Circuit Breaker, Failover 전략을 구체적으로 설명해주세요.",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "APISIX의 설정 저장소로 etcd 클러스터를 구성했나요? etcd의 고가용성과 데이터 일관성을 어떻게 보장했는지 설명해주세요.",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "Kafka Connect 기반 CDC(Change Data Capture) 파이프라인에서 어떻게 모니터링 체계를 구축했나요? Oracle LogMiner 기반 CDC를 운영할 때 특히 어떤 메트릭이 중요했나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "온프레미스 환경에서 고가용성 관측성 플랫폼(OTEL + Prometheus + Loki + Tempo + Grafana)을 직접 구축했을 때 가장 어려웠던 설계 결정은 무엇이었나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "Apache Airflow를 KubernetesExecutor로 운영할 때 기존 CeleryExecutor 대비 SRE 관점에서 어떤 트레이드오프가 있었나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "OTLP 텔레메트리 데이터를 Kafka를 통해 PostgreSQL에 장기 보관하는 파이프라인을 Go로 직접 개발했는데, 왜 Kafka를 중간에 두었나요? 단순히 OTLP → PostgreSQL 직접 삽입과 비교해서 어떤 장점이 있었나요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "3중화 OTEL Collector 환경에서 Kubernetes 이벤트를 중복 수집하지 않으려면 어떻게 해야 하나요? Leader Election을 Collector에 적용한 경험을 설명해주세요.",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "Loki에서 로그 수집량이 급증했을 때 rate limit 문제를 어떻게 해결했나요? TSDB 스키마 전환과 retention 정책 설계 경험을 함께 설명해주세요.",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    category2: "Alerting",
    question: {
      ko: "Prometheus recording rule을 활용해서 복합 헬스 스코어 메트릭을 설계한 경험이 있나요? SRE 관점에서 단순 임계치 알림 대신 복합 지표를 쓰는 이유는 무엇인가요?",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "Prometheus metric cardinality 폭발을 경험한 적 있나요? OTLP에서 Prometheus로 메트릭을 보낼 때 cardinality가 급증하는 원인과 해결 방법을 구체적으로 설명해주세요.",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "OTEL Collector에서 수집 데이터 볼륨을 줄이기 위해 어떤 processor들을 실제로 적용했나요? health check 트래픽, 중복 로그, Kafka Connect 메트릭 필터링 경험을 구체적으로 설명해주세요.",
    },
    answer: {
      ko:
  ...
  },
  {
    ...
    question: {
      ko: "분산 추적에서 trace sampling 전략을 어떻게 설계했나요? 모든 trace를 수집하는 것과 sampling을 적용하는 것 사이에서 어떤 선택을 했고 왜 그렇게 결정했나요?",
    },
    answer: {
      ko:
  ...
  // ─── AI / LLM Observability ────────────────────────────────────────────
  {
    ...
    priority: "high",
    question: {
      ko: "AI 멀티 에이전트 환경(ADK-Go, MCP)에서 Observability를 어떻게 구현했나요? 에이전트별·유저별 토큰 사용량, 캐싱 효율, 비용 추적을 Grafana로 어떻게 시각화하고 의사결정에 활용했는지 설명해주세요.",
    },
    answer: {
      ko:
