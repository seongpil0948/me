...
export const interviewQuestions: InterviewQuestion[] = [
  // Kakao Bank Specific Questions
  {
    id: 1,
    category1: "General",
    category2: "Company Interest",
    question:
      "What are your specific reasons for wanting to join Kakao Bank, and what are your goals after joining?",
    answer:
      "Through designing and operating distributed systems handling large-scale traffic, I've deeply resonated with Kakao Bank's vision of **'innovating finance through technology'**. Currently, I operate infrastructure maintaining 99.9% availability while processing 20-50 million daily messages for an e-commerce platform with ₩500B annual revenue. Through this experience, I've developed a practical sense of the stability and scalability required by financial services.\n\nI'm particularly impressed by how Kakao Bank is rapidly evolving based on cloud-native architecture, actively utilizing Kubernetes and MSA to secure both service agility and stability. My experience of reducing error detection time from 18 hours to 10 minutes (99% improvement) with an OpenTelemetry-based observability platform, and shortening deployment time from 2 hours to 12 minutes (90% improvement) through CI/CD pipeline optimization, aligns precisely with Kakao Bank's DevOps culture.\n\n**After joining, I aim to achieve three goals:**\n\n**1. Stable Cloud Infrastructure Operations**: Based on AWS Advanced Networking Specialty and DevOps Professional certifications, I will operate Kakao Bank's cloud infrastructure more efficiently and robustly.\n\n**2. Advanced Observability**: Leveraging my OpenTelemetry open-source contribution experience, I will further reduce failure detection and response time.\n\n**3. Data Pipeline Optimization**: Based on my experience operating 200+ Airflow DAGs, I will build automated pipelines supporting data-driven decision-making for financial services.",
  },
  {
    id: 2,
    category1: "General",
    category2: "Company Interest",
    question:
      "Kakao Bank is the same but different bank. Based on your differentiated capabilities and technology, describe why you are suitable for the applied position.",
    answer:
      "**First, Legacy Modernization and Hybrid Architecture Transformation Experience.**\n\nI designed and executed a non-disruptive migration strategy while transforming a monolithic system based on Oracle/Tomcat, operated for over 10 years, into Next.js and Spring Boot-based microservices. Since the financial industry also has an environment where legacy and modern technology coexist, my experience of gradual modernization while maintaining stability will be of direct help.\n\n**Second, End-to-End Observability Platform Construction Capability.**\n\nI reduced average failure detection time by 99% by integrating OpenTelemetry, Grafana, and Prometheus, and contributed AWS and cloud-native related issues to the OpenTelemetry open-source. Additionally, holding CKA, LFCS, and three AWS certifications (Advanced Networking, DevOps Professional, SysOps), I can support fast failure response and stable operations even in complex distributed environments.\n\n**Third, Data Pipeline and Business Intelligence Capability.**\n\nI processed over 20TB of monthly data while operating 200+ DAGs with a 5-node Apache Airflow cluster. Through an AWS Glue and Athena-based data lake, I expanded log retention period from 7 days to 10 years (142x improvement) and visualized key KPIs such as customer retention rate and conversion rate through Grafana BI dashboards. This experience can directly connect to financial data analysis and regulatory compliance.\n\n**Additionally**, my experience processing 20-50 million daily messages through Apache Kafka and operating Redis Sentinel-based high availability clusters aligns with Kakao Bank's real-time financial transaction system requirements. The **technical depth and adaptability** accumulated over 6 years, from startup solo developer to enterprise platform engineer, are my strengths that can immediately contribute in Kakao Bank's rapidly changing technical environment.",
  },
