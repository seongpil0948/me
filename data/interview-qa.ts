...
export const interviewQuestions: InterviewQuestion[] = [
  ...
  // Infrastructure - Kubernetes
  {
    ...
    answer:
      "I've developed and operated applications in EKS environments since the beginning of my career and hold **CKA certification**.\n\n**Key Experience:**\n- Current: Operating 100+ containers in EKS environment\n- Abacus: Built on-premise Kubernetes cluster (1 Master, 2 Workers)\n- Experience with CNI networking, security contexts, RBAC configuration\n- Keycloak SSO integration, APISIX Gateway integration\n\n**Problem-Solving**: Rich practical experience including container network issues, node resource troubleshooting, and Pod scheduling optimization.",
  },
  {
    id: 8,
    category1: "Infrastructure",
  ...
  },
  {
    ...
    answer:
      "Extensive experience with **CloudFormation** for AWS infrastructure automation.\n\n**Achievements:**\n- 90% deployment speedup (2 hours → 12 minutes)\n- Consistent infrastructure provisioning across environments\n- Version-controlled infrastructure changes\n- Automated rollback capabilities\n\n**Best Practices:**\n- Modular template design for reusability\n- Parameter-driven configurations\n- Stack policies for change protection\n- Integration with CI/CD pipelines",
  },
  {
    id: 13,
    category1: "Infrastructure",
  ...
  // Problem Solving
  {
    ...
    answer:
      "**(STAR Method)**\n\n**(Situation)** When joining idstrust, observability was impossible for 100+ containers after MSA transition, and identifying failure causes took an average of **18 hours**.\n\n**(Task)** Goal was to achieve complete observability for all containers and dramatically reduce failure detection time.\n\n**(Action)**\n1. **Led OpenTelemetry adoption**: Developed custom Exporter in Go\n2. **Built Collectors on 12 servers**: Integrated with Grafana dashboards\n3. **Data-driven persuasion**: Quantified MTTI of 18 hours in engineering costs to convince leadership\n4. **Education & evangelization**: Conducted usage sessions for development teams\n\n**(Result)**\n- MTTI **reduced 99.5%** (18 hours → 10 minutes)\n- Maximized development team productivity\n- OpenTelemetry open-source contributions",
  },
  {
    id: 23,
    category1: "General",
